...
Organizations (WHO and WMO) as a standardized measure of UV
...
wavelengths in the O\textsubscript{3} Huggins band\citep{Veefkind_2006}, while clouds are estimated from the reflectivity at a wavelength not affected by O\textsubscript{3} absorption (360 nm, \citet{Tanskanen_2007}). A correction for absorbing aerosols is made using a global aerosol climatology.\citep{Arola_2009}
...
\begin{table}[H]
  ...
  \caption{{UVI maxima for June-July: averages and standard deviation from ground-based data
        ...
        UVI ground-based and the same for satellite in the period 2005-2019. TUV calculations for specified conditions.
      }}
...
\begin{figure}[H]
  ...
  \caption{The percentage relative difference (\% RD) of the satellite and ground-based monthly means UVI for the period 2005-2019.}
  \label{fig:percentage_relative_difference}
\end{figure}

Figure \ref{fig:percentage_relative_difference} shows the percentage relative difference between monthly means
satellite-based and ground-based data with respect to the last one. The mean percentage relative difference
