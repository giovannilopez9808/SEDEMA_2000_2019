...
Measurements of the ozone profile and the attenuation by clouds are used via a
radiative transfer model to estimate the UVI at the ground.\cite{Tanskanen_2006}
...
Above the atmospheric boundary layer, the model atmosphere was specified to be,
...
several locations (CHO, MER, MON, PED, SAG, SFE and TLA). UV Index calculated with
the TUV model was used as reference of the behavior during clear sky days.
...
as shown at CHO station around noon in 13 June
...
by~\(UVI_{\max}\), these values were counted in the period 2000-2019.
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{{Boxplot of the monthly averages of the maximum UV Index values~(black
          ...
          interquartile range (box edges), 10\% and 90\% percentiles (the whiskers),
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{{3-month running average (violet segments curve) applied to monthly
...
While early OMI estimates of the UVI did not account for the boundary layer aerosol absorption,
...
MCMA pollutants as input. Note that SIMAT and TUV values are in good agreement
for both 2018-2019 and 2000-2001 and are considerably lower than for case (1). Compared to the OMI
...
\begin{table}[H]
  ...
  \begin{tabular}{lc}
    ...
    \begin{tabular}[c]{@{}l@{}}OMI maximum value reached in period 2005-2019,\\ not corrected for BL aerosols\end{tabular}                      & 16.6              \\ \hline
    \begin{tabular}[c]{@{}l@{}}TUV "zero" pollution \\ AOD 0, O3 0 ppb, NO2 0 ppb, SO2 0 ppb\end{tabular}                      & 16.1              \\ \hline
    \begin{tabular}[c]{@{}l@{}}TUV pristine pollution\\ AOD 0.05, O3 10 ppb, NO2 0 ppb, SO2 0 ppb\end{tabular}                      & 15.6              \\ \hline
    \begin{tabular}[c]{@{}l@{}}TUV 2019:\\ AOD 0.5, O3 50 ppb, NO2 20 ppb, SO2 1 ppb\end{tabular}                      & 12.1              \\ \hline
    \begin{tabular}[c]{@{}l@{}}TUV 2000:\\ AOD 0.7, O3 70 ppb, NO2 40 ppb, SO2 20 ppb\end{tabular}                      & 10.2              \\ \hline
  \end{tabular}
  \caption{{UVI maxima for June-July: averages and standard deviation from ground-based data
        for the years 2018-2019 and 2000-2001. UVI maximum value reached in the period 2000-2019 for
        UVI ground-based and the same for satellite in the period 2005-2019. TUV calculations for different conditions.
      }}
...
2000-2019 UVI increase results in comparable proportions from
less aerosols, less SO\textsubscript{2}, and the combined reductions in
...
are accompanied by statistically significant increases in the
...
\begin{table}[H]
  ...
  \begin{tabular}{lccccc}
    \hline
    \multicolumn{1}{c}{\multirow{2}{*}{Pollutant}} & \multicolumn{2}{c}{Year 2000} & \multicolumn{2}{c}{Year 2019} & 2000-2019                 \\ \cline{2-6}
...
improved by adding observation sites within or close to the Valley of Mexico, with minor
influences of the urban plume (e. g., Amecameca; latitude: 19.13°N, longitude: 99.76°W, elevation: 2420 m asl),
